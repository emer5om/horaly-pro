...
export default function CustomersEdit() {
    const { customer, planFeatures = [] } = usePage<PageProps>().props;
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        list_type: customer.list_type || 'regular',
            ...
            <div className="@container/main flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Atualize os dados do cliente {customer.name}</p>
                    </div>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Atualize os dados básicos do cliente</CardDescription>
                    </CardHeader>
                    <CardContent>
