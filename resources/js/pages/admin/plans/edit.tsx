...
export default function EditPlan({ auth, plan }: EditPlanProps) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        monthly_appointment_limit: plan.monthly_appointment_limit?.toString() || '',
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">Editar Plano: {plan.name}</h1>
                            <p className="text-gray-600">Modifique as informações do plano</p>
                        </div>
                    </div>
                </div>
