...
export default function EditEstablishment({ establishment, plans, auth }: PageProps) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        plan_id: establishment.plan.id.toString() || '',
        ...
        <AdminLayout auth={auth}>
            ...
            <div className="@container/main flex flex-1 flex-col gap-4">
                <div className="flex flex-col gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-bold sm:text-2xl">Editar Estabelecimento</h1>
                        <p className="text-sm text-muted-foreground sm:text-base">Atualize as informações do estabelecimento</p>
                    </div>
                </div>
